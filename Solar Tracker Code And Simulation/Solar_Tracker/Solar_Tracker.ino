...
if(pos > endpos) {pos = endpos;} // reset the horizontal postion of the motor to 180 if it tries to move past this point
if(pos < startpos) {pos = startpos;} // reset the horizontal position of the motor to 0 if it tries to move past this point
